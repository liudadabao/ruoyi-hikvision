...
package org.dromara.hikvision.sdk;

import com.sun.jna.*;
import org.dromara.hikvision.sdk.win32.W32API;
...
interface USER32 extends W32API {
    ...
    boolean DrawEdge(HDC hdc, org.dromara.hikvision.sdk.win32.W32API.RECT qrc, int edge, int grfFlags);

    int FillRect(HDC hDC, org.dromara.hikvision.sdk.win32.W32API.RECT lprc, HANDLE hbr);
}
